               ...
               <AboutContent>
                  <AboutCard>
                     ...
                     <AboutCardPara>
                        ...
                        <br />
                        Hi, I am <span className='name'>Foysal Ahmmed</span>, a Bengali based Web Developer & Designer. Currently
                        I am focusing on Full Stack & MERN Stack Development. I have completed 12 years of education based on
                        Science Department. Last 1.5 years I have learned many Languages, Tools & Technologies like HTML, CSS,
                        JavaScript, ReactJS, NodeJS, ExpressJS, MongoDB, GitHub, Netlify, Yarn, NPM, Visual Studio Code etc. I
                        have completed 55+ projects with the help of these Technologies. I have 1.5+ years of Coding Experience
                        with Bug Fixing. I have few knowledge about Java, Android Studio, NextJS, ReduxJS. I am an experienced Web
                        Development Specialist with a demonstrated history of working in the Computer Software Industry!
                     </AboutCardPara>
                  </AboutCard>
               </AboutContent>
            </MainContainer>
